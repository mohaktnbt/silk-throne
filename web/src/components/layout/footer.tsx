        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              ...
              <li>
                <Link href="/account" className="inline-flex items-center min-h-[44px] text-sm text-muted-foreground hover:text-gold transition-colors">
                  Account
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              <li>
                <Link href="/terms" className="inline-flex items-center min-h-[44px] text-sm text-muted-foreground hover:text-gold transition-colors">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="inline-flex items-center min-h-[44px] text-sm text-muted-foreground hover:text-gold transition-colors">
                  Privacy Policy
                </Link>
              </li>
            </ul>
