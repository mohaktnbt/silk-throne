...
export function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay + Drawer — outside nav to escape backdrop-blur stacking context */}
      {mobileOpen && (
        <>
          {/* Backdrop */}
          <div
          ...
          />
          {/* Drawer */}
          <div className="fixed inset-y-0 right-0 z-[70] w-72 border-l border-border bg-background p-6 shadow-lg">
            <button
